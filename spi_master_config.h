...
/*  SPI0 */
#define SPI_PSELSCK0              25u   /*!< GPIO pin number for SPI clock (P3.1) (note that setting this to 31 will only work for loopback purposes as it not connected to a pin) */
#define SPI_PSELMOSI0             20u   /*!< GPIO pin number for Master Out Slave In (P2.4)    */
#define SPI_PSELMISO0             22u  /*!< GPIO pin number for Master In Slave Out (P2.6)   */
#define SPI_PSELSS0               24u  /*!< GPIO pin number for Slave Select. (P3.0)           */
 
/*  SPI1 */
#define SPI_PSELSCK1              29u   /*!< GPIO pin number for SPI clock              */
#define SPI_PSELMOSI1             21u   /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO1             23u   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS1               28u   /*!< GPIO pin number for Slave Select           */
