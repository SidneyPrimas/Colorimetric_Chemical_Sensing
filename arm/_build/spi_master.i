...
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 113, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (pp_buf != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 146, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_buf_len != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 147, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_index != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 148, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
static __inline void spi_master_buffer_release(uint8_t * volatile * const pp_buf,
                                               volatile uint16_t * const  p_buf_len)
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (pp_buf != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 161, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_buf_len != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 162, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 175, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 192, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
static __inline void spi_master_send_recv_irq(volatile spi_master_instance_t * const p_spi_instance)
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 216, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
                         ...
                         spi_master_config_t const * const p_spi_master_config)
{
    ...
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 274, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_ClearPendingIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 321, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_SetPriority(p_spi_instance ->irq_type, p_spi_master_config->SPI_PriorityIRQ)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 322, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_EnableIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 329, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
void spi_master_close(const spi_master_hw_instance_t spi_master_hw_instance)
{
    ...
    volatile spi_master_instance_t * p_spi_instance = spi_master_get_instance(
        spi_master_hw_instance);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 349, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);

     
    do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_ClearPendingIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 352, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_DisableIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 353, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    ...
    const spi_master_hw_instance_t spi_master_hw_instance)
{
    ...
    volatile spi_master_instance_t * p_spi_instance = spi_master_get_instance(
        spi_master_hw_instance);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 379, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
                                         ...
                                         spi_master_event_handler_t     event_handler)
{
    ...
    volatile spi_master_instance_t * p_spi_instance = spi_master_get_instance(
        spi_master_hw_instance);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 393, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
                              ...
                              uint8_t * const p_rx_buf, const uint16_t rx_buf_len)
{
    ...
    volatile spi_master_instance_t * p_spi_instance = spi_master_get_instance(
        spi_master_hw_instance);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 409, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    ...
    if (p_spi_instance->disable_all_irq)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_critical_region_enter(&nested_critical_region)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 420, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    }
    else
    {
        
        do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_DisableIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 425, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    }
    ...
    {   
        ...
        do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_critical_region_exit(nested_critical_region)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 469, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    }
    else
    {
        
        do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_EnableIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 474, (uint8_t*) "..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    }
