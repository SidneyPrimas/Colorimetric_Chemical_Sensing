...
uint32_t SPI0_LTC2492_Read(void) {
	...
	_Bool is_neg = (output_data & (0x1UL << 28)) >> 28; 
	
	int32_t measured_value = 0;
	if (is_neg) {
		measured_value = -1*(((~output_data & (0xFFFFFE0U) ) >> 5));
	} else if(!is_neg) {
		measured_value = (output_data & (0xFFFFFE0U) ) >> 5;
	}
