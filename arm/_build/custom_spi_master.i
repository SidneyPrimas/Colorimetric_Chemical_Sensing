...
uint32_t* spi_master_init(SPIModuleNumber module_number, SPIMode mode, _Bool lsb_first)
{
    ...
    if(SPI0 == module_number)
    {
        ...
        nrf_gpio_cfg_output(25u);
        nrf_gpio_cfg_output(20u);
        nrf_gpio_cfg_input(22u, NRF_GPIO_PIN_NOPULL);
        nrf_gpio_cfg_output(24u);

         
        spi_base_address->PSELSCK  = 25u;
        spi_base_address->PSELMOSI = 20u;
        spi_base_address->PSELMISO = 22u;
        nrf_gpio_pin_set(24u);  
    }
    else
    {
         
        nrf_gpio_cfg_output(29u);
        nrf_gpio_cfg_output(21u);
        nrf_gpio_cfg_input(23u, NRF_GPIO_PIN_NOPULL);
        nrf_gpio_cfg_output(28u);

         
        spi_base_address->PSELSCK  = 29u;
        spi_base_address->PSELMOSI = 21u;
        spi_base_address->PSELMISO = 23u;
        nrf_gpio_pin_set(28u);          
    }
